...
var Rule = function () {
  ...
  * @param {CalEvent} [calEvent]
  ...
  Rule.prototype.setEvent = function setEvent(calEvent) {
    this.calEvent = calEvent;
    return this;
  };
  ...
  Rule.prototype.getEvent = function getEvent() {
  ...
  Rule.prototype.setModifier = function setModifier(modifier) {
  ...
  Rule.prototype.resolve = function resolve(rule) {
  ...
  Rule.prototype.dateDir = function dateDir(rule) {
  ...
  Rule.prototype.dateIfThen = function dateIfThen(rule) {
    var _this = this;
  ...
  Rule.prototype.weekday = function weekday(rule) {
    this.calEvent.dates = this.calEvent.dates.map(function (date) {
      var weekday = date.getDay();
  ...
  Rule.prototype.time = function time(rule) {
    this.calEvent.dates.forEach(function (date) {
      date.setTime(rule.hour, rule.minute);
    });
  };

  Rule.prototype.duration = function duration(rule) {
    this.calEvent.dates.forEach(function (date) {
      date.duration = rule.duration;
    });
  };

  Rule.prototype.bridge = function bridge() {
  ...
  Rule.prototype.year = function year(rule) {
    var _this2 = this;
  ...
  Rule.prototype._isLeapYear = function _isLeapYear(year) {
