...
var Parser = function () {
  function Parser(fns) {
    ...
    this.fns = fns || ['_julian', '_date', '_easter', '_islamic', '_hebrew', '_equinox', '_chineseSolar', '_chineseLunar', '_dateMonth', '_ruleDateIfThen', '_ruleWeekday', '_ruleYear', '_ruleDateDir', '_ruleBridge', '_ruleTime', '_ruleDuration', '_ruleModifier', '_ruleSameDay'];
    this.tokens = [];
  }

  Parser.prototype.parse = function parse(rule) {
  ...
  Parser.prototype._reorder = function _reorder() {
    var tmp = [];
    var res = [];
  ...
  Parser.prototype._tokenize = function _tokenize(o) {
    var last = void 0;
    while (o.str) {
  ...
  Parser.prototype._shorten = function _shorten(o, cap0) {
    o.str = o.str.substr(cap0.length, o.str.length);
  };

  Parser.prototype._date = function _date(o) {
    var cap = void 0;
  ...
  Parser.prototype._julian = function _julian(o) {
    var cap = void 0;
  ...
  Parser.prototype._easter = function _easter(o) {
    var cap = void 0;
  ...
  Parser.prototype._equinox = function _equinox(o) {
    var cap = void 0;
  ...
  Parser.prototype._hebrew = function _hebrew(o) {
    var cap = void 0;
  ...
  Parser.prototype._islamic = function _islamic(o) {
    var cap = void 0;
  ...
  Parser.prototype._chineseSolar = function _chineseSolar(o) {
    var cap = void 0;
  ...
  Parser.prototype._chineseLunar = function _chineseLunar(o) {
    var cap = void 0;
  ...
  Parser.prototype._dateMonth = function _dateMonth(o) {
    var cap = void 0;
  ...
  Parser.prototype._space = function _space(o) {
    var cap = void 0;
  ...
  Parser.prototype._ruleSameDay = function _ruleSameDay(o) {
    var cap = void 0;
  ...
  Parser.prototype._ruleModifier = function _ruleModifier(o) {
    var cap = void 0;
  ...
  Parser.prototype._ruleTime = function _ruleTime(o) {
    var cap = void 0;
  ...
  Parser.prototype._ruleDuration = function _ruleDuration(o) {
    var cap = void 0;
  ...
  Parser.prototype._ruleDateIfThen = function _ruleDateIfThen(o) {
    var cap = void 0;
  ...
  Parser.prototype._ruleWeekday = function _ruleWeekday(o) {
    var cap = void 0;
  ...
  Parser.prototype._ruleDateDir = function _ruleDateDir(o) {
    var cap = void 0;
  ...
  Parser.prototype._ruleYear = function _ruleYear(o) {
    var cap = void 0;
  ...
  Parser.prototype._ruleBridge = function _ruleBridge(o) {
    var cap = void 0;
