...
export var Moon = function () {
  function Moon(jde) {
    ...
    this.Ω = base.horner(T, 125.0445479 * D2R, -1934.1362891 * D2R, 0.0020754 * D2R, D2R / 467441, -D2R / 60616000);
    // true ecliptic
  ...
  Moon.prototype.lib = function lib(λ, β) {
  ...
  Moon.prototype.optical = function optical(λ, β) {
    // (53.1) p. 372
  ...
  Moon.prototype.physical = function physical(A, b_) {
    // (53.2) p. 373
  ...
  Moon.prototype.pa = function pa(λ, β, b) {
  ...
  Moon.prototype.sun = function sun(λ, β, Δ, earth) {
