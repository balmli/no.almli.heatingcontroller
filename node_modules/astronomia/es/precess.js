...
export var Precessor = function () {
  ...
  Precessor.prototype.precess = function precess(eqFrom) {
    // (21.4) p. 134
 ...
 * different coordinates with the same initial and final epochs.
 */
export var EclipticPrecessor = function () {
  /**
  ...
  EclipticPrecessor.prototype.precess = function precess(eclFrom) {
    // (21.7) p. 137
  ...
  EclipticPrecessor.prototype.reduceElements = function reduceElements(eFrom) {
    var ψ = this.π + this.p;
