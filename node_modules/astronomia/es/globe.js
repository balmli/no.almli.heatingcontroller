...
export var Ellipsoid = function () {
  ...
  Ellipsoid.prototype.A = function A() {
    return this.radius;
  };
  ...
  Ellipsoid.prototype.B = function B() {
  ...
  Ellipsoid.prototype.eccentricity = function eccentricity() {
  ...
  Ellipsoid.prototype.parallaxConstants = function parallaxConstants(φ, h) {
    var boa = 1 - this.flat;
  ...
  Ellipsoid.prototype.rho = function rho(φ) {
    // Magic numbers...
  ...
  Ellipsoid.prototype.radiusAtLatitude = function radiusAtLatitude(φ) {
    var s = Math.sin(φ);
    var c = Math.cos(φ);
  ...
  Ellipsoid.prototype.radiusOfCurvature = function radiusOfCurvature(φ) {
    var s = Math.sin(φ);
  ...
  Ellipsoid.prototype.distance = function distance(c1, c2) {
    // From AA, ch 11, p 84.
