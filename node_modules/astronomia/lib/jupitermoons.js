...
exports.callisto = exports.ganymede = exports.europa = exports.io = undefined;
...
var _planetelements = require('./planetelements');

var _planetelements2 = _interopRequireDefault(_planetelements);
...
var io = exports.io = 0;
var europa = exports.europa = 1;
var ganymede = exports.ganymede = 2;
var callisto = exports.callisto = 3;
...
function positions(jde) {
  ...
  var _base$sincos = _base2.default.sincos(M),
      _base$sincos2 = _slicedToArray(_base$sincos, 2),
      sM = _base$sincos2[0],
      cM = _base$sincos2[1];

  var _base$sincos3 = _base2.default.sincos(N),
      _base$sincos4 = _slicedToArray(_base$sincos3, 2),
      sN = _base$sincos4[0],
      cN = _base$sincos4[1];

  var _base$sincos5 = _base2.default.sincos(2 * M),
  ...
  var _base$sincos9 = _base2.default.sincos(K),
  ...
  var xy = function xy(u, r) {
    var _base$sincos19 = _base2.default.sincos(u),
...
function e5(jde, earth, jupiter, pos) {
  ...
  var λ0 = void 0,
      ...
      t = void 0;
  var Δ = 5.0;(function () {
    var _solar$trueVSOP = _solar2.default.trueVSOP87(earth, jde),
    ...
    var _base$sincos21 = _base2.default.sincos(s),
    ...
    function f() {
      ...
      var _base$sincos23 = _base2.default.sincos(lon),
          _base$sincos24 = _slicedToArray(_base$sincos23, 2),
          sl = _base$sincos24[0],
          cl = _base$sincos24[1];

      var _base$sincos25 = _base2.default.sincos(lat),
  ...
  var R = void 0;(function () {
    ...
    // p. 311
    var T0 = (jde - 2433282.423) / _base2.default.JulianCentury;
    var P = (1.3966626 * p + 0.0003088 * p * T0) * T0;
    for (var i in L) {
      L[i] += P;
    }
    ψ += P;
    var T = (jde - _base2.default.J1900) / _base2.default.JulianCentury;
    I = 3.120262 * p + 0.0006 * p * T;
    for (var _i in L) {
      var _base$sincos27 = _base2.default.sincos(L[_i] - ψ),
          _base$sincos28 = _slicedToArray(_base$sincos27, 2),
          sLψ = _base$sincos28[0],
          cLψ = _base$sincos28[1];

      var _base$sincos29 = _base2.default.sincos(B[_i]),
  ...
  var _base$sincos31 = _base2.default.sincos(I),
      _base$sincos32 = _slicedToArray(_base$sincos31, 2),
      sI = _base$sincos32[0],
      cI = _base$sincos32[1];

  var Ω = _planetelements2.default.node(_planetelements2.default.jupiter, jde);

  var _base$sincos33 = _base2.default.sincos(Ω),
      _base$sincos34 = _slicedToArray(_base$sincos33, 2),
      sΩ = _base$sincos34[0],
      cΩ = _base$sincos34[1];

  var _base$sincos35 = _base2.default.sincos(ψ - Ω),
      _base$sincos36 = _slicedToArray(_base$sincos35, 2),
      sΦ = _base$sincos36[0],
      cΦ = _base$sincos36[1];

  var _base$sincos37 = _base2.default.sincos(_planetelements2.default.inc(_planetelements2.default.jupiter, jde)),
      _base$sincos38 = _slicedToArray(_base$sincos37, 2),
      si = _base$sincos38[0],
      ci = _base$sincos38[1];

  var _base$sincos39 = _base2.default.sincos(λ0),
      _base$sincos40 = _slicedToArray(_base$sincos39, 2),
      sλ0 = _base$sincos40[0],
      cλ0 = _base$sincos40[1];

  var _base$sincos41 = _base2.default.sincos(β0),
  ...
  var _base$sincos43 = _base2.default.sincos(Math.atan2(A[4], C[4])),
