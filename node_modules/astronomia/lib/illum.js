...
var toDeg = _base2.default.toDeg;
...
function phaseAngle3(L, B, x, y, z, Δ) {
  ...
  // (41.4) p. 283
  var _base$sincos = _base2.default.sincos(L),
...
function mercury84(r, Δ, i) {
  // (r, Δ, i float64)  float64
  return _base2.default.horner(toDeg(i), -0.42 + 5 * Math.log10(r * Δ), 0.038, -0.000273, 0.000002);
}
...
function venus84(r, Δ, i) {
  // (r, Δ, i float64)  float64
  return _base2.default.horner(toDeg(i), -4.4 + 5 * Math.log10(r * Δ), 0.0009, 0.000239, -0.00000065);
}
