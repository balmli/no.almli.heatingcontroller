...
function time(r1, d1, r2, d2, r3, d3, t1, t5) {
  ...
  var l5 = new _interpolation2.default.Len5(t1, t5, gc);
...
function angle(r1, d1, r2, d2, r3, d3) {
  ...
  var _base$sincos = _base2.default.sincos(d2),
      _base$sincos2 = _slicedToArray(_base$sincos, 2),
      sd2 = _base$sincos2[0],
      cd2 = _base$sincos2[1];

  var _base$sincos3 = _base2.default.sincos(r2 - r1),
      _base$sincos4 = _slicedToArray(_base$sincos3, 2),
      sr21 = _base$sincos4[0],
      cr21 = _base$sincos4[1];

  var _base$sincos5 = _base2.default.sincos(r3 - r2),
