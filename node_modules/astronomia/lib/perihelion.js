...
exports.embary = exports.neptune = exports.uranus = exports.saturn = exports.jupiter = exports.mars = exports.earth = exports.venus = exports.mercury = undefined;
 ...
 */
var planets = {};
var mercury = exports.mercury = planets.mercury = 0;
var venus = exports.venus = planets.venus = 1;
var earth = exports.earth = planets.earth = 2;
var mars = exports.mars = planets.mars = 3;
var jupiter = exports.jupiter = planets.jupiter = 4;
var saturn = exports.saturn = planets.saturn = 5;
var uranus = exports.uranus = planets.uranus = 6;
var neptune = exports.neptune = planets.neptune = 7;
var embary = exports.embary = planets.embary = 8;
...
var ap = function ap(p, y, a, f) {
  ...
  var j = _base2.default.horner(k, c[i]);
  if (p === earth) {
    var _c = ep;
    if (a) {
      _c = ea;
...
var ap2a = function ap2a(j1, d, a, v, cb) {
  ...
  function end() {
    var l = new _interpolation2.default.Len3(j0, j2, rr);
