...
var _nutation6 = require('./nutation');

var _nutation7 = _interopRequireDefault(_nutation6);
...
function nutation(α, δ, jd) {
  ...
  var ε = _nutation7.default.meanObliquity(jd);
...
function perihelion(T) {
  // (T float64)  float64
  return _base2.default.horner(T, 102.93735, 1.71946, 0.00046) * Math.PI / 180;
}
...
function eclipticAberration(λ, β, jd) {
  ...
  var T = _base2.default.J2000Century(jd);

  var _solar$trueLongitude = _solar2.default.trueLongitude(T),
      lon = _solar$trueLongitude.lon,
      ano = _solar$trueLongitude.ano; // eslint-disable-line no-unused-vars


  var e = _solar2.default.eccentricity(T);
  var π = perihelion(T);
  ...
  var _base$sincos7 = _base2.default.sincos(lon - λ),
      _base$sincos8 = _slicedToArray(_base$sincos7, 2),
      ssλ = _base$sincos8[0],
      csλ = _base$sincos8[1];

  var _base$sincos9 = _base2.default.sincos(π - λ),
...
function aberration(α, δ, jd) {
  ...
  var _solar$trueLongitude2 = _solar2.default.trueLongitude(T),
...
function position(eqFrom, epochFrom, epochTo, mα, mδ) {
  ...
  var eqTo = _precess2.default.position(eqFrom, epochFrom, epochTo, mα, mδ);
  var jd = _base2.default.JulianYearToJDE(epochTo);
...
var rvTerm = [function (r) {
  // 1
  var _base$sincos23 = _base2.default.sincos(r.L3),
  ...
  // 2
  var _base$sincos25 = _base2.default.sincos(2 * r.L3),
  ...
  // 3
  var _base$sincos27 = _base2.default.sincos(r.L5),
  ...
  // 4
  var _base$sincos29 = _base2.default.sincos(r.Lp),
  ...
  // 5
  var _base$sincos31 = _base2.default.sincos(3 * r.L3),
  ...
  // 6
  var _base$sincos33 = _base2.default.sincos(r.L6),
  ...
  // 8
  var _base$sincos35 = _base2.default.sincos(r.Lp + r.Mp),
  ...
  // 9
  var _base$sincos37 = _base2.default.sincos(2 * r.L5),
  ...
  // 10
  var _base$sincos39 = _base2.default.sincos(2 * r.L3 - r.L5),
  ...
  // 11
  var _base$sincos41 = _base2.default.sincos(3 * r.L3 - 8 * r.L4 + 3 * r.L5),
  ...
  // 12
  var _base$sincos43 = _base2.default.sincos(5 * r.L3 - 8 * r.L4 + 3 * r.L5),
  ...
  // 13
  var _base$sincos45 = _base2.default.sincos(2 * r.L2 - r.L3),
  ...
  // 14
  var _base$sincos47 = _base2.default.sincos(r.L2),
  ...
  // 15
  var _base$sincos49 = _base2.default.sincos(r.L7),
  ...
  // 16
  var _base$sincos51 = _base2.default.sincos(r.L3 - 2 * r.L5),
  ...
  // 17
  var _base$sincos53 = _base2.default.sincos(r.L8),
  ...
  // 18
  var _base$sincos55 = _base2.default.sincos(r.L3 + r.L5),
  ...
  // 19
  var _base$sincos57 = _base2.default.sincos(2 * r.L2 - 2 * r.L3),
  ...
  // 20
  var _base$sincos59 = _base2.default.sincos(r.L3 - r.L5),
  ...
  // 21
  var _base$sincos61 = _base2.default.sincos(4 * r.L3),
  ...
  // 22
  var _base$sincos63 = _base2.default.sincos(3 * r.L3 - 2 * r.L5),
  ...
  // 23
  var _base$sincos65 = _base2.default.sincos(r.L2 - 2 * r.L3),
  ...
  // 24
  var _base$sincos67 = _base2.default.sincos(2 * r.L2 - 3 * r.L3),
  ...
  // 25
  var _base$sincos69 = _base2.default.sincos(2 * r.L6),
  ...
  // 26
  var _base$sincos71 = _base2.default.sincos(2 * r.L2 - 4 * r.L3),
  ...
  // 27
  var _base$sincos73 = _base2.default.sincos(3 * r.L3 - 2 * r.L4),
  ...
  // 28
  var _base$sincos75 = _base2.default.sincos(r.Lp + 2 * r.D - r.Mp),
  ...
  // 29
  var _base$sincos77 = _base2.default.sincos(8 * r.L2 - 12 * r.L3),
  ...
  // 30
  var _base$sincos79 = _base2.default.sincos(8 * r.L2 - 14 * r.L3),
  ...
  // 31
  var _base$sincos81 = _base2.default.sincos(2 * r.L4),
  ...
  // 32
  var _base$sincos83 = _base2.default.sincos(3 * r.L2 - 4 * r.L3),
  ...
  // 33
  var _base$sincos85 = _base2.default.sincos(2 * r.L3 - 2 * r.L5),
  ...
  // 34
  var _base$sincos87 = _base2.default.sincos(3 * r.L2 - 3 * r.L3),
  ...
  // 35
  var _base$sincos89 = _base2.default.sincos(2 * r.L3 - 2 * r.L4),
  ...
  // 36
  var _base$sincos91 = _base2.default.sincos(r.Lp - 2 * r.D),
...
function positionRonVondrak(eqFrom, epochTo, mα, mδ) {
  ...
  eqTo.ra += Δα;
  eqTo.dec += Δδ;
  eqTo = _precess2.default.position(eqTo, 2000, epochTo, 0, 0);
