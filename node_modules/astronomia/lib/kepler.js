...
function kepler1(e, m, places) {
  ...
  return _iterate2.default.decimalPlaces(f, m, places, places * 5);
}
...
function kepler2(e, m, places) {
  ...
  var f = function f(E0) {
    var _base$sincos = _base2.default.sincos(E0),
  ...
  return _iterate2.default.decimalPlaces(f, m, places, places);
}
...
function kepler2a(e, m, places) {
  // (e, M float64, places int)  (E float64, err error)
  var f = function f(E0) {
    var _base$sincos3 = _base2.default.sincos(E0),
...
function kepler2b(e, m, places) {
  // (e, M float64, places int)  (E float64, err error)
  var f = function f(E0) {
    var _base$sincos5 = _base2.default.sincos(E0),
...
function kepler3(e, m) {
  ...
  m = _base2.default.pmod(m, 2 * Math.PI);
  var f = 1;
  if (m > Math.PI) {
    f = -1;
    m = 2 * Math.PI - m;
...
function kepler4(e, m) {
  // (e, m float64)  (E float64)
  var _base$sincos7 = _base2.default.sincos(m),
