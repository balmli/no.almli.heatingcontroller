...
exports.MOON_RADIUS = exports.EARTH_RADIUS = undefined;
...
var EARTH_RADIUS = exports.EARTH_RADIUS = 6378.137; // km
// from http://nssdc.gsfc.nasa.gov/planetary/factsheet/moonfact.html
var MOON_RADIUS = exports.MOON_RADIUS = 1738.1; // km
...
var mean = function mean(T) {
  return _base2.default.horner(T, 2451534.6698, 27.55454989 / ck, -0.0006691, -0.000001098, 0.0000000052);
};
...
var La = function () {
  function La(y, h) {
    ...
    this.D = _base2.default.horner(this.T, 171.9179 * D2R, 335.9106046 * D2R / ck, -0.0100383 * D2R, -0.00001156 * D2R, 0.000000055 * D2R);
    this.M = _base2.default.horner(this.T, 347.3477 * D2R, 27.1577721 * D2R / ck, -0.000813 * D2R, -0.000001 * D2R);
    this.F = _base2.default.horner(this.T, 316.6109 * D2R, 364.5287911 * D2R / ck, -0.0125053 * D2R, -0.0000148 * D2R);
    return this;
  }
