...
function heliocentric(jde) {
  ...
  for (var i in t37) {
    ...
    var _base$sincos = _base2.default.sincos((t.i * J + t.j * S + t.k * P) * Math.PI / 180),
...
function astrometric(jde, earth) {
  ...
  var f = function f(jde) {
    ...
    var _base$sincos3 = _base2.default.sincos(lon),
        _base$sincos4 = _slicedToArray(_base$sincos3, 2),
        sl = _base$sincos4[0],
        cl = _base$sincos4[1];

    var _base$sincos5 = _base2.default.sincos(lat),
  ...
  var c = _elliptic2.default.astrometricJ2000(f, jde, earth); // eslint-disable-line no-unused-vars
  return new _base2.default.Coord(c.ra, c.dec);
}
