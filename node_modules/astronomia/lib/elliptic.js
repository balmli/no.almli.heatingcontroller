...
var _apparent = require('./apparent');

var _apparent2 = _interopRequireDefault(_apparent);
...
var _solarxyz = require('./solarxyz');

var _solarxyz2 = _interopRequireDefault(_solarxyz);
...
function position(planet, earth, jde) {
  ...
  var _base$sincos = _base2.default.sincos(B0),
      _base$sincos2 = _slicedToArray(_base$sincos, 2),
      sB0 = _base$sincos2[0],
      cB0 = _base$sincos2[1];

  var _base$sincos3 = _base2.default.sincos(L0),
  ...
  function pos() {
    ...
    var _base$sincos7 = _base2.default.sincos(L),
  ...
  var _apparent$eclipticAbe = _apparent2.default.eclipticAberration(λ, β, jde),
      _apparent$eclipticAbe2 = _slicedToArray(_apparent$eclipticAbe, 2),
      Δλ = _apparent$eclipticAbe2[0],
      Δβ = _apparent$eclipticAbe2[1];

  var fk5 = _planetposition2.default.toFK5(λ + Δλ, β + Δβ, jde);
  λ = fk5.lon;
  β = fk5.lat;
  ...
  return new _coord2.default.Ecliptic(λ, β).toEquatorial(ε);
...
var Elements = exports.Elements = function () {
  /*
  ...
  */
  ...
  _createClass(Elements, [{
    ...
    value: function position(jde, earth) {
      ...
      // (α, δ, ψ float64) {
      // (33.6) p. 227
      var n = _base2.default.K / this.axis / Math.sqrt(this.axis);
      var sε = _base2.default.SOblJ2000;
      var cε = _base2.default.COblJ2000;

      var _base$sincos9 = _base2.default.sincos(this.node),
          _base$sincos10 = _slicedToArray(_base$sincos9, 2),
          sΩ = _base$sincos10[0],
          cΩ = _base$sincos10[1];

      var _base$sincos11 = _base2.default.sincos(this.inc),
      ...
      var f = function f(jde) {
        ...
        var E = void 0;
        try {
          E = _kepler2.default.kepler2b(_this.ecc, M, 15);
        } catch (e) {
          E = _kepler2.default.kepler3(_this.ecc, M);
        }
        var ν = _kepler2.default.trueAnomaly(E, _this.ecc);
        var r = _kepler2.default.radius(E, _this.ecc, _this.axis);
        // (33.9) p. 229
...
function astrometricJ2000(f, jde, earth) {
  ...
  var sol = _solarxyz2.default.positionJ2000(earth, jde);
  ...
  return new _base2.default.Coord(α, δ, undefined, ψ);
}
