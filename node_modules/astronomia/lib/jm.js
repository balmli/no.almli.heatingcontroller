...
function JewishCalendar(y) {
  ...
  // year.
  var y1 = y + 1;
  var lf = _julian2.default.LeapYearGregorian;
  if (y1 < 1583) {
    lf = _julian2.default.LeapYearJulian;
  }
  var days = 365;
  if (lf(y1)) {
    days++;
...
var bigD = function bigD(y) {
  // (y int)  int
  var C = _base2.default.floorDiv(y, 100);
  // const S int
  var S = 0;
  if (y >= 1583) {
    S = int(_base2.default.floorDiv(3 * C - 5, 4));
  }
  var a = (12 * y + 12) % 19;
  var b = y % 4;
...
function MoslemToJD(y, m, d) {
  ...
  var N = d + _base2.default.floorDiv(295001 * (m - 1) + 9900, 10000);
  var Q = _base2.default.floorDiv(y, 30);
  var R = y % 30;
  var A = _base2.default.floorDiv(11 * R + 3, 30);
  var W = 404 * Q + 354 * R + 208 + A;
  var Q1 = _base2.default.floorDiv(W, 1461);
  var Q2 = W % 1461;
  var G = 621 + 28 * Q + 4 * Q1;
  var K = _base2.default.floorDiv(Q2 * 10000, 3652422);
  var E = _base2.default.floorDiv(3652422 * K, 10000);
  var J = Q2 - E + N - 1;
  var X = G + K;
  if (J > 366 && X % 4 === 0) {
    J -= 366;
  ...
  var jd = _base2.default.floorDiv(36525 * (X - 1), 100) + 1721423 + J;
  return jd;
}
...
function JulianToMoslem(y, m, d) {
  ...
  var N = _base2.default.floorDiv(275 * m, 9) - W * _base2.default.floorDiv(m + 9, 12) + d - 30;
  var A = int(y - 623);
  var B = _base2.default.floorDiv(A, 4);
  var C2 = function (A) {
    var C = A % 4;
    var C1 = 365.25001 * C;
  ...
  var Q = _base2.default.floorDiv(Dp, 10631);
  var R = Dp % 10631;
  var J = _base2.default.floorDiv(R, 354);
  var K = R % 354;
  var O = _base2.default.floorDiv(11 * J + 14, 30);
  var my = 30 * Q + J + 1;
  var JJ = K - O + N - 1;
  var days = 354;
  if (MoslemLeapYear(y)) {
  ...
  if (JJ === 355) {
    ...
    var S = _base2.default.floorDiv((JJ - 1) * 10, 295);
    mm = 1 + S;
    md = _base2.default.floorDiv(10 * JJ - 295 * S, 10);
  }
