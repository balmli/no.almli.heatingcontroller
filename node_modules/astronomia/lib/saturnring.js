...
function cl(jde, earth, saturn) {
  ...
  var f1 = function f1() {
    ...
    i = _base2.default.horner(T, 28.075216 * p, -0.012998 * p, 0.000004 * p);
    Ω = _base2.default.horner(T, 169.50847 * p, 1.394681 * p, 0.000412 * p);
    // Step 2.0
    ...
    var f = function f() {
      ...
      r = saturnPos.range;
      var fk5 = _planetposition2.default.toFK5(saturnPos.lon, saturnPos.lat, jde);
      l = fk5.lon;
      b = fk5.lat;
    ...
    var _base$sincos7 = _base2.default.sincos(λ - Ω),
  ...
  var f2 = function f2() {
    ...
    var _base$sincos9 = _base2.default.sincos(l0 - λ),
    ...
    λ += Δψ;
    // Step 14.0
    var eq = new _coord2.default.Ecliptic(λ0, β0).toEquatorial(ε);
    ...
    var _base$sincos11 = _base2.default.sincos(δ0),
    ...
    var _base$sincos15 = _base2.default.sincos(α0 - α),
