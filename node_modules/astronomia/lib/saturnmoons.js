...
exports.iapetus = exports.hyperion = exports.titan = exports.rhea = exports.dione = exports.tethys = exports.enceladus = exports.mimas = undefined;
...
var _planetposition = require('./planetposition');
...
var mimas = exports.mimas = 0;
var enceladus = exports.enceladus = 1;
var tethys = exports.tethys = 2;
var dione = exports.dione = 3;
var rhea = exports.rhea = 4;
var titan = exports.titan = 5;
var hyperion = exports.hyperion = 6;
var iapetus = exports.iapetus = 7;
...
function positions(jde, earth, saturn) {
  var sol = _solar2.default.trueVSOP87(earth, jde);
  var _ref = [sol.lon, sol.lat, sol.range],
      s = _ref[0],
      β = _ref[1],
      R = _ref[2];

  var _base$sincos = _base2.default.sincos(s),
  ...
  var f = function f() {
    ...
    var fk5 = _planetposition2.default.toFK5(lon, lat, _jde);
    var _ref2 = [fk5.lon, fk5.lat],
        l = _ref2[0],
        b = _ref2[1];

    var _base$sincos3 = _base2.default.sincos(l),
        _base$sincos4 = _slicedToArray(_base$sincos3, 2),
        sl = _base$sincos4[0],
        cl = _base$sincos4[1];

    var _base$sincos5 = _base2.default.sincos(b),
  ...
  var ecl = new _coord2.default.Ecliptic(λ0, β0);
  ecl = _precess2.default.eclipticPosition(ecl, _base2.default.JDEToJulianYear(jde), _base2.default.JDEToJulianYear(_base2.default.B1950), 0, 0);
  λ0 = ecl.lon;
  β0 = ecl.lat;
  var q = new Qs(_jde);
  ...
  for (var j = 1; j <= 8; j++) {
    ...
    var _base$sincos7 = _base2.default.sincos(u),
    ...
    var _base$sincos11 = _base2.default.sincos(s4[j].γ),
  ...
  var _base$sincos13 = _base2.default.sincos(λ0),
      _base$sincos14 = _slicedToArray(_base$sincos13, 2),
      sλ0 = _base$sincos14[0],
      cλ0 = _base$sincos14[1];

  var _base$sincos15 = _base2.default.sincos(β0),
...
Qs.prototype.rhea = function () {
  ...
  var _base$sincos19 = _base2.default.sincos(pʹ),
  ...
  var _base$sincos21 = _base2.default.sincos(N),
...
Qs.prototype.subr = function (λʹ, p, e, a, Ω, i) {
  ...
  var _base$sincos23 = _base2.default.sincos(i),
      _base$sincos24 = _slicedToArray(_base$sincos23, 2),
      si = _base$sincos24[0],
      ci = _base$sincos24[1];

  var _base$sincos25 = _base2.default.sincos(g),
...
Qs.prototype.titan = function () {
  ...
  var _base$sincos27 = _base2.default.sincos(iʹ),
      _base$sincos28 = _slicedToArray(_base$sincos27, 2),
      siʹ = _base$sincos28[0],
      ciʹ = _base$sincos28[1];

  var _base$sincos29 = _base2.default.sincos(Ωʹ - this.W8),
  ...
  var _base$sincos31 = _base2.default.sincos(2 * g0),
  ...
  var _base$sincos33 = _base2.default.sincos(qq),
  ...
  var _base$sincos35 = _base2.default.sincos(u),
...
Qs.prototype.iapetus = function () {
  ...
  var iʹ = _base2.default.horner(this.t11, 18.4602 * d, -0.9518 * d, -0.072 * d, 0.0054 * d);
  var Ωʹ = _base2.default.horner(this.t11, 143.198 * d, -3.919 * d, 0.116 * d, 0.008 * d);
  var l = μ - ϖ0;
  var g = ϖ0 - Ωʹ - ψ;
  var g1 = ϖ0 - Ωʹ - φ;
  var ls = this.W5 - ϖʹ;
