...
exports.neptune = exports.uranus = exports.saturn = exports.jupiter = exports.mars = exports.earth = exports.venus = exports.mercury = undefined;
...
var mercury = exports.mercury = 'mercury';
var venus = exports.venus = 'venus';
var earth = exports.earth = 'earth';
var mars = exports.mars = 'mars';
var jupiter = exports.jupiter = 'jupiter';
var saturn = exports.saturn = 'saturn';
var uranus = exports.uranus = 'uranus';
var neptune = exports.neptune = 'neptune';
...
function Elements(lon, axis, ecc, inc, node, peri) {
  var o = (typeof lon === 'undefined' ? 'undefined' : _typeof(lon)) === 'object' ? lon : {};
  this.lon = o.lon || lon;
...
var cMean = {
  ...
  var c = cMean[p];
  e = e || new Elements();
  e.lon = _base2.default.pmod(_base2.default.horner(T, c.L) * Math.PI / 180, 2 * Math.PI);
  e.axis = _base2.default.horner(T, c.a);
  e.ecc = _base2.default.horner(T, c.e);
  e.inc = _base2.default.horner(T, c.i) * Math.PI / 180;
  e.node = _base2.default.horner(T, c.Ω) * Math.PI / 180;
  e.peri = _base2.default.horner(T, c.ϖ) * Math.PI / 180;
  return e;
}
...
function inc(p, jde) {
  ...
  return _base2.default.horner(_base2.default.J2000Century(jde), cMean[p].i) * Math.PI / 180;
}
...
function node(p, jde) {
  // (p int, jde float64)  float64
  return _base2.default.horner(_base2.default.J2000Century(jde), cMean[p].Ω) * Math.PI / 180;
}
