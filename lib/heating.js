...
let isDay = function (aDate, opts) {
    ...
    let startHour = isWorkDay(aDate, opts) ? opts.workday.startHour : opts.notWorkday.startHour;
    let endHour = isWorkDay(addDate(aDate, 1), opts) ? opts.workday.endHour : opts.notWorkday.endHour;
