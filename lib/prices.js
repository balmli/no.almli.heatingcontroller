...
const pricesLowestInPeriod = (prices, aDate, startHour, numHours, numLowestHours) => {
  // Finds prices in period
  const pricesInPeriod = pricesStarting(prices, aDate, startHour, numHours);
...
const pricesHighestInPeriod = (prices, aDate, startHour, numHours, numHighestHours) => {
  // Finds prices in period
  const pricesInPeriod = pricesStarting(prices, aDate, startHour, numHours);
  if (pricesInPeriod.length === 0) {
    return false;
