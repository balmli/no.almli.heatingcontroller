...
const getPrices = function () {
    if (_prices) {
        const aDate = moment('2019-01-20T22:00:00.000Z');
    ...
    const prices = [
        {
            startsAt: '2019-01-20T22:00:00.000Z',
            priceArea: 'FI',
            currency: 'EUR',
            price: 0.49599
        },
...
describe("Prices", function () {
    ...
    describe("Check low price", function () {
        ...
        checkLowPrice('2019-01-21', '07:00:00', 1);
        checkLowPrice('2019-01-21', '08:00:00', 0);
        checkLowPrice('2019-01-21', '09:00:00', 0);
        checkLowPrice('2019-01-21', '10:00:00', 0);
        ...
        checkLowPrice('2019-01-21', '16:00:00', 1);
        checkLowPrice('2019-01-21', '17:00:00', 0);
        checkLowPrice('2019-01-21', '18:00:00', 0);
        checkLowPrice('2019-01-21', '19:00:00', 0);
    ...
    describe("Check high price - working day - home", function () {
        ...
        checkHighPrice('2019-01-21', '02:00:00', state, 1);
